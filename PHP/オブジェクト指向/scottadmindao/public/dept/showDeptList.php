...
/**
 * PH35 サンプル5 マスタテーブル管理DAO版 Src07/13
 * 部門情報リスト表示。
 *
 * @author Shinzo SAITO
 *
...
$deptList = [];
/**
 * try,catch,finallyは、トランザクションの関係からDAOにまとめない方がよい(対象テーブルが分からなくなる&むしろ重複してごちゃごちゃする)
 * →各SQLの処理のみDAOに入れとく！！トランザクション処理は実行PHPファイルで処理する
 */
try {
    $db = new PDO(Conf::DB_DNS, Conf::DB_USERNAME, Conf::DB_PASSWORD);
    /**
     * newするときに$db渡しとけば、DAO内でprepareとかできる！！
     * →DAO側のconstructで$dbを処理
     */
