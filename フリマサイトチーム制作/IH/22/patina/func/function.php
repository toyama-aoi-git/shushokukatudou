...
**/
function ratio_img(int $width_img, int $height_img, int $width, int $height){
...
function compression_img(
    ...
    if($extension == "jpg" || $extension == "JPG" || $extension == "jpeg" || $extension == "JPEG"){
        $file_name = mb_convert_encoding($saveName,'sjis','utf8');
